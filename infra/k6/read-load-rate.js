...
//
// 옵션 이름에 K6_ 접두사를 쓰지 않는다. K6_DURATION 같은 이름은 k6 자신의 환경변수 옵션이라
// 여기 scenarios 설정을 통째로 덮어쓴다("env level configuration overrode scenarios configuration
// entirely" 경고와 함께 executor가 사라지고 VU 1개로 돈다).
//
// 관측은 대시보드에서 함께 본다(k6 지표를 Prometheus remote write로 보낸다):
