...
//   2) 순서 보존: 진입 순번(rank) 순서대로 승격된다
//   3) 나머지는 대기: 입장 못 한 사용자는 에러(5xx)가 아니라 WAITING을 받는다
//
// executor는 per-vu-iterations 여야 한다. 1인 1토큰이라 VU와 사용자가 1:1로 고정되는데,
// shared-iterations는 전체 iteration을 VU들이 나눠 가져 그 전제가 깨진다(hold-contention.js와 같은 이유).
//
// 실행:
