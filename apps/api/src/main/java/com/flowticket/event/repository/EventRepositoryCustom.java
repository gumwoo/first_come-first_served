...
public interface EventRepositoryCustom {
     ...
     *
     * 엔티티가 아니라 요약 DTO를 돌려준다. 목록이 실제로 쓰는 컬럼은 9개인데
     * selectFrom(event)는 엔티티의 모든 컬럼(20개, KOPIS 상세 TEXT 포함)을 읽는다.
     *
     * 성능 개선 근거로 둔 것이 아니다. EXPLAIN (ANALYZE, BUFFERS)에서 쿼리 형태별 차이는
