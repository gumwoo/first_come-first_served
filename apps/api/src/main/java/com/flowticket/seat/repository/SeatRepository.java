...
public interface SeatRepository extends JpaRepository<Seat, Long> {
    ...
    /**
     * 공연의 잔여 좌석 수 — 선점 실패가 매진인지 좌석 경합인지 가르는 데만 쓴다.
     ...
     * 그 실패를 SOLD_OUT으로 볼지 SEAT_CONFLICT로 볼지는 잔여 좌석 수가 가른다(SeatService 참고).
     */
    ...
    /**
     * 좌석 상태 복구(해제/만료/환불) — 조건부. 기대 상태(:from)인 좌석만 복구한다.
